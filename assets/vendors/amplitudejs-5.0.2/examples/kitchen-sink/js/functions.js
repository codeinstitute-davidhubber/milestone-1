...
$(document).ready(function(){
	...
	*/
	jQuery('.song').on('mouseover', function(){
		jQuery(this).css('background-color', '#F9AC3D');
		...
		jQuery(this).find('img.wiki-brown').css('display', 'none');
		jQuery(this).find('img.wiki-orange').css('display', 'block');
	...
	*/
	jQuery('.song').on('mouseout', function(){
		...
		jQuery(this).find('img.wiki-brown').css('display', 'block');
		jQuery(this).find('img.wiki-orange').css('display', 'none');
